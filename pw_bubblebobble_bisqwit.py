...
while True:
	mode=input("(1) ~ Get a password\n(2) ~ Decipher\n")
	if mode=="1":
		try:
			levelnum,issuper,something=int(input("Which level? (from 1-159)")),input("Is this a Super Bubble Bobble Game? (Y/N)").lower(),int(input("What is the value of \"Something\"? (from 0-3)"))
		...
		pw=input("Enter your password (valid characters: ABCDEFGHIJ): ")
